...
def test():
    with tf.Graph().as_default() as g: 
        ...
        ema = tf.train.ExponentialMovingAverage(gesture_backward.MOVING_AVERAGE_DECAY)
        ...
        img_batch, label_batch = gesture_generateds.get_tfrecord(TEST_NUM, isTrain=False)#2
